...
BEGIN
    ...
    INSERT INTO AULA_BD.ALUNO(NOME,DT_NASCIMENTO) VALUES (AULA_BD.HELLO('CEIOT'),DATE('1982-03-11')); 
END;
//
delimiter ;
...
/*Index*/
CREATE UNIQUE INDEX INDEX_ALUNO ON AULA_BD.ALUNO (ID);
